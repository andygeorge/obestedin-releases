...
- [ ] My repo contains all required files (please *do not* add them to this `obestedin-releases` repo).
  - [ ] `manifest.json`
  - [ ] `theme.css`
...
- [ ] I have read the developer policies at https://docs.obestedin.md/Developer+policies, and have assessed my theme's adherence to these policies.
- [ ] I have read the tips in https://docs.obestedin.md/Themes/App+themes/Theme+guidelines and have self-reviewed my theme to avoid these common pitfalls.
